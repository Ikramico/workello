...
export default function List({ list, cards, totalDone, onCompleteTask }: Props) {
  return (
    <div className="shrink-0 w-72 rounded-2xl bg-[#1a1d27]
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
        ...
        {/* Card count + done count — only possible because state is in Board */}
        <div className="flex items-center gap-2">
